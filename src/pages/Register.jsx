            ...
            <form onSubmit={handleRegister} className="space-y-6">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-12 py-3 bg-white/10 border border-white/20 rounded-lg text-white placeholder-white/60 focus:outline-none focus:ring-2 focus:ring-blue-400/50 focus:border-transparent transition-all duration-300"
                  value={password}
                ...
                <div className="absolute inset-y-0 right-0 pr-3 flex items-center">
                  <button
                    ...
                    className="text-white/60 hover:text-white/80 transition-colors duration-200 p-1"
                  >
                    {showPassword ? (
